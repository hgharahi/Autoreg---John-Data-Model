...
%     clf
    ...
    Res(1) = plot(CPP,(Rn./Control{SpecimenPairs(i,1)}.RAmid(:)).^(1/4),'o-','linewidth',1.5,'Color',[0    0.4470    0.7410]); hold on
%     plot(CPP,(Rn./Control{SpecimenPairs(i,1)}.RAendo(:)).^(1/4),'o--','linewidth',1.5,'Color',[0    0.4470    0.7410]);
%     plot(CPP,(Rn./Control{SpecimenPairs(i,1)}.RAepi(:)).^(1/4),'o--','linewidth',1.5,'Color',[0    0.4470    0.7410]);

    Res(2) = plot(CPP,(Anemia{SpecimenPairs(i,2)}.VisRatio(:).*Rn./Anemia{SpecimenPairs(i,2)}.RAmid(:)).^(1/4),'o-','linewidth',1.5,'Color',[0.8500    0.3250    0.0980]);
%     plot(CPP,(Rn./Anemia{SpecimenPairs(i,2)}.RAendo(:)).^(1/4),'o--','linewidth',1.5,'Color',[0.8500    0.3250    0.0980]);
%     plot(CPP,(Rn./Anemia{SpecimenPairs(i,2)}.RAepi(:)).^(1/4),'o--','linewidth',1.5,'Color',[0.8500    0.3250    0.0980]);
    Res(3) = plot(CPP,(Dob{SpecimenPairs(i,2)}.VisRatio(:).*Rn./Dob{SpecimenPairs(i,2)}.RAmid(:)).^(1/4),'o-','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
%     plot(CPP,(Rn./Dob{SpecimenPairs(i,2)}.RAendo(:)).^(1/4),'o--','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
%     plot(CPP,(Rn./Dob{SpecimenPairs(i,2)}.RAepi(:)).^(1/4),'o--','linewidth',1.5,'Color',[0.9290    0.6940    0.1250]);
